  ...
  return (
    <MenuItem
      style={{
        ...
        backgroundColor: selected === title ? colors.primary[400] : "transparent",
      }}
    ...
    <ProSidebarProvider>
      ...
      >
        <Sidebar  collapsed={isCollapsed}>
          <Menu style={{ backgroundColor: 'black', height: "100vh" }}>
            {/* LOGO AND MENU ICON */}
            <MenuItem
            ...
            <Box paddingLeft={isCollapsed ? undefined : "10%"}>
              ...
              <Item title="Patient Information" to="/dashboard/contacts" icon={<ContactsOutlinedIcon />} selected={selected} setSelected={setSelected} />
              <Item title="Invoices Balances" to="/dashboard/invoices" icon={<ReceiptOutlinedIcon />} selected={selected} setSelected={setSelected} />

              <Typography variant="h6" color={colors.grey[300]} sx={{ m: "15px 0 5px 20px" }}>
                Manage
              </Typography>
              <Item title="Patient Registration" to="/dashboard/form" icon={<PersonOutlinedIcon />} selected={selected} setSelected={setSelected} />
              {/* <Item title="Calendar" to="/dashboard/calendar" icon={<CalendarTodayOutlinedIcon />} selected={selected} setSelected={setSelected} /> */}
              <Item title="FAQ Page" to="/dashboard/faq" icon={<HelpOutlineOutlinedIcon />} selected={selected} setSelected={setSelected} />
